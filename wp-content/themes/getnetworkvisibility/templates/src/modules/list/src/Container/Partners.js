...
import PartnersList from "../Design/PartnersList";
import Pagination from "../Design/Pagination";

export default class Partners extends ListComponent {
    constructor(props) {
        super(props);
    ...
    // getList() {
    //     const $this = this;
    //     const {state: {params: $params, list: $list}} = $this;
    //
    //     if ($params.size < 1) {
    //         $list.clear();
    //         $this.setState({list: $list, totalPages: 0, totalPosts: 0});
    //
    //         $this.UrlManager.$params = $params;
