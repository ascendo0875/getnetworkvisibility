...
class Market extends RegisterTaxonomy
{
    const TAXONOMY_NAME = 'market';

    const SINGULAR_NAME = 'Market';
    const PLURAL_NAME = 'Markets';

    public static function getInstance(string $taxonomyName = self::TAXONOMY_NAME, string $class = Market::class): Market
    {
