...
class PartnerType extends RegisterTaxonomy
{
    const TAXONOMY_NAME = 'partner-type';

    const SINGULAR_NAME = 'Partner Type';
    const PLURAL_NAME = 'Partner Types';

    public static function getInstance(string $taxonomyName = self::TAXONOMY_NAME, string $class = PartnerType::class): PartnerType
    {
    ...
    public function __construct(string $taxonomyName)
    {
        ...
        $this->setLabel(self::PLURAL_NAME)
            ...
            ->setShowInMenu(true)
            ->setShowInRest(true)
            ->setRewrite(['slug' => 'type', 'with_front' => true])
            ->register();
    }
}
