...
class Region extends RegisterTaxonomy
{
    const TAXONOMY_NAME = 'region';

    const SINGULAR_NAME = 'Region';
    const PLURAL_NAME = 'Regions';

    public static function getInstance(string $taxonomyName = self::TAXONOMY_NAME, string $class = Region::class): Region
    {
