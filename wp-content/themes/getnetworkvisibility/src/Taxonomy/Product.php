...
class Product extends RegisterTaxonomy
{
    const TAXONOMY_NAME = 'product';

    const SINGULAR_NAME = 'Product';
    const PLURAL_NAME = 'Products';

    public static function getInstance(string $taxonomyName = self::TAXONOMY_NAME, string $class = Product::class): Product
    {
