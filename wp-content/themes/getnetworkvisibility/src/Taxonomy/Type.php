...
class Type extends RegisterTaxonomy
{
    const TAXONOMY_NAME = 'resource-type';

    const SINGULAR_NAME = 'Type';
    const PLURAL_NAME = 'Types';

    public static function getInstance(string $taxonomyName = self::TAXONOMY_NAME, string $class = Type::class): Type
    {
