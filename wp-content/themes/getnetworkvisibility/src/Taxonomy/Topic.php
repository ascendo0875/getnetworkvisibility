...
class Topic extends RegisterTaxonomy
{
    const TAXONOMY_NAME = 'topic';

    const SINGULAR_NAME = 'Topic';
    const PLURAL_NAME = 'Topics';

    public static function getInstance(string $taxonomyName = self::TAXONOMY_NAME, string $class = Topic::class): Topic
    {
