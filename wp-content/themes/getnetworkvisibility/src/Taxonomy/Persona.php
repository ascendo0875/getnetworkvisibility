...
class Persona extends RegisterTaxonomy
{
    const TAXONOMY_NAME = 'persona';

    const SINGULAR_NAME = 'Persona';
    const PLURAL_NAME = 'Personas';

    public static function getInstance(string $taxonomyName = self::TAXONOMY_NAME, string $class = Persona::class): Persona
    {
