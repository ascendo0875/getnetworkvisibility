...
class Solution extends RegisterPostType
{
    const POST_TYPE = 'solution';
    const SEARCH_GETTER = 'query-solution';

    const SINGULAR_NAME = 'Solution';
    const PLURAL_NAME = 'Solutions';
     ...
     * @return Solution
     */
    public static function getInstance(string $postType = self::POST_TYPE, string $class = Solution::class): Solution
    {
