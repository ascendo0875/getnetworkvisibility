...
class Industry extends RegisterPostType
{
    const POST_TYPE = 'industry';
    const SEARCH_GETTER = 'query-industry';

    const SINGULAR_NAME = 'Industry';
    const PLURAL_NAME = 'Industries';

    const ICON = 'dashicons-media-document';
     ...
     * @return Industry
     */
    public static function getInstance(string $postType = self::POST_TYPE, string $class = Industry::class): Industry
    {
