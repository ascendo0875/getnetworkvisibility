...
class Customer extends RegisterPostType
{
    const POST_TYPE = 'customer';
    const SEARCH_GETTER = 'query-customer';

    const SINGULAR_NAME = 'Customer';
    const PLURAL_NAME = 'Customers';
     ...
     * @return Customer
     */
    public static function getInstance(string $postType = self::POST_TYPE, string $class = Customer::class): Customer
    {
