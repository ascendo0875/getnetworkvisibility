...
class Product extends RegisterPostType
{
    const POST_TYPE = 'product';
    const SEARCH_GETTER = 'query-product';

    const SINGULAR_NAME = 'Product';
    const PLURAL_NAME = 'Products';

    const ICON = 'dashicons-store';
     ...
     * @return Product
     */
    public static function getInstance(string $postType = self::POST_TYPE, string $class = Product::class): Product
    {
